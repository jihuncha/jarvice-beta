 ...
 *
 * */
public class TBL_WEEK_SALES extends TABLE<MonthSalesObject> {
    private String TAG = TBL_WEEK_SALES.class.getSimpleName();
    ...
    public static final String SELL_ALL			    = "sell_all";             // 주 매출 총
    public static final String SELL_FOOD			= "sell_food";            // 카드매충
    public static final String SELL_ALCOHOLIC		= "sell_alcoholic";            // 현금매출
    public static final String SELL_COCKTAIL		= "sell_cocktail";            // 현금매출
    public static final String SELL_LIQUOR		    = "sell_liquor";     // 현금매출
    public static final String SELL_DRINK			= "sell_drink";     // 현금매출
...
//        idx.SELL_CASH               = c.getColumnIndex(SELL_CASH);
    ...
    /*** 생성자 *************************/
    public TBL_WEEK_SALES(SQLiteDatabase db) {
        super(db, TABLE_NAME);
    }
