...
public class TBL_CATEGORY_SALES extends TABLE<SalesObject> {
    private String TAG = TBL_CATEGORY_SALES.class.getSimpleName();
    ...
    public static final String SELL_DATE		    = "DATE";                   // 날짜
    ...
    /*** 생성자 *************************/
    public TBL_CATEGORY_SALES(SQLiteDatabase db) {
        super(db, TABLE_NAME);
    }
